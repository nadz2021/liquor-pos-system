      ...
      <div class="nav">
        ...
        <div class="nav-links">
          ...
          <?php if (Auth::can('reports.view')): ?>
            <div class="nav-dropdown <?= str_starts_with($path, '/reporting') ? 'active' : '' ?>">
              <span class="dropdown-label">Reporting ▾</span>

              <div class="dropdown-menu">
                <a href="/reporting">Dashboard</a>
                <a href="/reporting/products">Sales by Product</a>
                <a href="/reporting/categories">Sales by Category</a>
                <a href="/reporting/hours">Sales by Hour</a>
                <a href="/reporting/customers">Sales by Customer</a>
                <a href="/reporting/cashiers">Sales by Cashier</a>
                <a href="/reporting/refunds">Refund Report</a>
              </div>
            </div>
          <?php endif; ?>
